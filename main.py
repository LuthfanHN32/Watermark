...
def main(args):
    ...
    questions = [
        inquirer.List("type", message="Choice type", choices=["DCT", "DWT", "Attack"], default="DCT"),
    ]
    ...
    if answers['type'] in ["DCT", "DWT"]:
        ...
        questions = [
            inquirer.List("option", message="Choice option", choices=["embedding", "extracting"], default="extracting"),
        ]
        answers = inquirer.prompt(questions)
